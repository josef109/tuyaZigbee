...
{
	tuyaShutter_otaProcessMsgHandler,
};
#endif
...
s32 tuyaShutter_bdbNetworkSteerStart(void *arg){
...
s32 tuyaShutter_bdbFindAndBindStart(void *arg){
...
void zbShutter_bdbInitCb(u8 status, u8 joinedNetwork){
	...
	if(status == BDB_INIT_STATUS_SUCCESS){
		...
		if(joinedNetwork){
			...
			TL_ZB_TIMER_SCHEDULE(tuyaShutter_bdbNetworkSteerStart, NULL, jitter);
#endif
		}
	}else{
		heartInterval = 200;
...
s32 tuyaShutter_softReset(void *arg){
	SYSTEM_RESET();
...
/*********************************************************************
 * @fn      tuyaShutter_leaveCnfHandler
 *
...
/*********************************************************************
 * @fn      tuyaShutter_leaveIndHandler
 *
